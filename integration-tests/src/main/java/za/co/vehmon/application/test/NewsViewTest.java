...
package za.co.vehmon.application.test;

import static za.co.vehmon.application.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import za.co.vehmon.application.core.News;
import za.co.vehmon.application.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link za.co.vehmon.application.ui.CarouselActivity}
     */
    public NewsViewTest() {
