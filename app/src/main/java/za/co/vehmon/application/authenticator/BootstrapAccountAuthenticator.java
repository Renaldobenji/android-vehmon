...
import static za.co.vehmon.application.authenticator.BootstrapAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class BootstrapAccountAuthenticator extends AbstractAccountAuthenticator {
     ...
     * {@link za.co.vehmon.application.authenticator.ApiKeyProvider#getAuthKey()}
