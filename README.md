...
[![Build Status](https://travis-ci.org/AndroidBootstrap/za-co-vehmon-application.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/za-co-vehmon-application)

This repository contains the source code for the [vehmon](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=za.co.vehmon.application).

Please see the [issues](https://github.za.co.vehmon.application/za-co-vehmon-application/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about vehmon? Ask away on the [za-co-vehmon-application discussion forum](https://groups.google.com/forum/#!forum/za-co-vehmon-application).

<a href="https://play.google.com/store/apps/details?id=za.co.vehmon.application" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __za.co.vehmon.application__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____za.co.vehmon.application__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.za.co.vehmon.application.R__) will now be renamed
...
signed with a different key.  Manually uninstall vehmon from your device and
...
vehmon is a result of a template project I've developed over the years as well as
...
vehmon is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.za.co.vehmon.application/za-co-vehmon-application/contributors) on
...
[pull requests](https://github.za.co.vehmon.application/za-co-vehmon-application/pulls).
